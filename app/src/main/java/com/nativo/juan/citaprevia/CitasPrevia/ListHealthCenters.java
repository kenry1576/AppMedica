...
import com.nativo.juan.citaprevia.Adapters.HospitalAdapter;
import com.nativo.juan.citaprevia.R;
import com.nativo.juan.citaprevia.model.GeometryController;
...
public class ListHealthCenters extends AppCompatActivity {
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListHealthCenters.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    CitaPrevia.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
    ...
    protected void fillList() {
        ...
        HospitalAdapter customPlacesAdapter = new HospitalAdapter(this, placeName, ratingText, openNow);
